...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.log('[Register] signIn after signUp:', {
        signInData,
        signInError,
      });
  ...
  return (
    <div className={styles.pageWrapper}>
      {/* exakt wie auf /account: Video + Overlay + Center */}
      <video
      ...
      <div className={styles.center}>
        <div className={styles.card}>
          ...
          <p className={styles.subtitle}>
            Register with your email to link your future MEMEX purchases and NFT
            drops to a private account.
          </p>
